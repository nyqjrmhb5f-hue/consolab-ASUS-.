...
const LINES = [
  ...
  'Authority without proof is risk.',
  'Funds move. Systems execute. No one verifies.',
  'VERIFY BEFORE YOU TRUST.'
];

class DubaiAuthorityFlyer extends BaseGenerator {
  constructor() { super({ type: 'flyer', market: 'dubai', name: 'authority', subdir: 'flyers/dubai' }); }
  renderHTML(spec) {
    ...
    return `<!DOCTYPE html>
<html lang="en"><head><meta charset="UTF-8"><title>VYRDON FLYER — DUBAI 01 — AUTHORITY</title><style>
  ${baseStyles(ACCENT)}
...
export default new DubaiAuthorityFlyer();
