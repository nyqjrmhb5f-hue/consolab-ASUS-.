...
const LINES = [
  'CONTROL THE OUTCOME.',
  "Don't trust systems. Validate them.",
  'No proof \u2192 No acceptance.',
  'FAIL CLOSED.',
  'ENTER VYRDx.'
];

class DubaiControlFlyer extends BaseGenerator {
  constructor() { super({ type: 'flyer', market: 'dubai', name: 'control', subdir: 'flyers/dubai' }); }
  renderHTML(spec) {
    ...
    return `<!DOCTYPE html>
<html lang="en"><head><meta charset="UTF-8"><title>VYRDON FLYER — DUBAI 03 — CONTROL</title><style>
  ${baseStyles(ACCENT)}
...
export default new DubaiControlFlyer();
