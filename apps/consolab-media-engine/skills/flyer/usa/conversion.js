...
const LINES = [
  'TRY US ON YOUR SYSTEM.',
  'Send your API. Send your flow. Send your claim.',
  'We return STAMP / CERTIFICATE / RECEIPT / EVIDENCE HASH.',
  'CLICK. VERIFY. BREAK IT.'
];

class USAConversionFlyer extends BaseGenerator {
  constructor() { super({ type: 'flyer', market: 'usa', name: 'conversion', subdir: 'flyers/usa' }); }
  renderHTML(spec) {
    ...
    return `<!DOCTYPE html>
<html lang="en"><head><meta charset="UTF-8"><title>VYRDON FLYER — USA 03 — CONVERSION</title><style>
  ${baseStyles(ACCENT)}
...
export default new USAConversionFlyer();
