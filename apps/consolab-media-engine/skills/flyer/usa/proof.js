...
const LINES = [
  "WE DON'T TRUST YOUR SYSTEM.",
  'We verify it.',
  'ALL TRUE \u2192 ACCEPT',
  'ANY FALSE \u2192 REJECT',
  'RUN YOUR FIRST VALIDATION \u2014 FREE'
];

class USAProofFlyer extends BaseGenerator {
  constructor() { super({ type: 'flyer', market: 'usa', name: 'proof', subdir: 'flyers/usa' }); }
  renderHTML(spec) {
    ...
    return `<!DOCTYPE html>
<html lang="en"><head><meta charset="UTF-8"><title>VYRDON FLYER — USA 02 — PROOF</title><style>
  ${baseStyles(ACCENT)}
...
export default new USAProofFlyer();
