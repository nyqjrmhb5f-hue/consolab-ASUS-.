...
const ACCENT = MARKET_COLORS.usa;
const LINES = [
  'YOUR SYSTEM IS LYING.',
  "You execute. But you don't prove.",
  'COLOR \u2260 TRUTH',
  'SUCCESS \u2260 ACCEPTANCE',
...
class USAChallengeFlyer extends BaseGenerator {
  constructor() { super({ type: 'flyer', market: 'usa', name: 'challenge', subdir: 'flyers/usa' }); }
  renderHTML(spec) {
...
<title>VYRDON FLYER — USA 01 — CHALLENGE</title><style>
  ${baseStyles(ACCENT)}
  ...
  .line{font-size:1.5rem;font-weight:700;line-height:1.6;color:#fff;margin:.4rem 0;letter-spacing:.05em;}
  .line.headline{font-size:2.2rem;font-weight:900;color:${ACCENT};margin-bottom:1.5rem;}
  .line.cta{font-size:1.8rem;font-weight:900;color:${ACCENT};margin-top:1.5rem;padding:.5rem 1.5rem;border:2px solid ${ACCENT};display:inline-block;}
</style></head><body>
<div class="flyer"><div class="market-badge">USA MARKET</div>
...
export default new USAChallengeFlyer();
